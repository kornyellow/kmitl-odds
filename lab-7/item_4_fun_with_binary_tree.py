def main():
    ...
    print("Preorder : " + " ".join(list(map(str, binary_tree.preorder()))))
    print("Inorder : " + " ".join(list(map(str, binary_tree.inorder()))))
    print("Postorder : " + " ".join(list(map(str, binary_tree.postorder()))))
    print("Breadth : " + " ".join(list(map(str, binary_tree.breadthorder()))))
